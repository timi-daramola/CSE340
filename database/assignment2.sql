old database name: cse340 Database
New database name: cse340-Database
db name: cse340database
username: cse340db
...
CREATE TABLE public .classification (
	...
	classification_name CHARACTER VARYING NOT NULL, CONSTRAINT
	classification_pk PRIMARY KEY (classification_id)
);
